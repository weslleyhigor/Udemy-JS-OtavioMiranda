document.body.innerHTML += `<strong>Bem vindo ao MEU SISTEMA</strong> </br></br>`;

const nome = prompt('Digite o seu nome completo:')

let separaNome = nome.replace(/ /g, ""); // Remove todos os espaços entre os nomes

document.body.innerHTML += ` O seu nome é: <strong>${nome}</strong> </br>`;
document.body.innerHTML += `Seu nome tem: <strong>${separaNome.length}</strong> letras </br>`;
